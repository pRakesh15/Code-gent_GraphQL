...
// const rootDomain = 'rakesh.com'


//as we no when we use signIn of next-auth it will make a post request to the auth rout
//i redirect the auth-rout to this function 
